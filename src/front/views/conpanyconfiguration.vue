    ...
    <v-form v-model="valid">
      <v-container class="container_position" grid-list-md>
        ...
        <v-layout>
          ...
          <v-flex xs6 md6>
            <v-text-field :value="companyData.cif" id="c_cif" label="cif de la compañia" required></v-text-field>
          </v-flex>
        </v-layout>
        <v-layout>
          <v-flex xs12 md3>
        ...
        <v-layout>
          <v-flex xs12 md3>
            <v-text-field v-model="newContact" :rules="nameRules" label="nuevo contacto" required></v-text-field>
          </v-flex>
          <v-flex xs12 md3>
            <v-text-field
